...
public class GsonXml {
	...
	/**
	 * Reads the next JSON value from {@code reader} and convert it to an object of type {@code typeOfT}. Since Type is
	 * not parameterized by T, this method is type unsafe and should be used carefully
	 * 
	...
	public <T> T fromXml(final XmlReader reader, final Type typeOfT) throws JsonIOException, JsonSyntaxException {
		System.out.println("gson-xml" + " :: " + "Type: " + typeOfT.toString());
